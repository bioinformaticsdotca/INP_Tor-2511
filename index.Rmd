--- 
title: "Enter Full Workshop Name Here (e.g. Introduction to Python) Enter Year Here"
author: "Faculty: Andres Felipe Melani De La Hoz"
date: "Enter Dates Here (e.g. November 3-4, 2025)"
site: bookdown::bookdown_site
documentclass: book
bibliography: [book.bib, packages.bib]
url: https://bioinformaticsdotca.github.io/Workshop Code (e.g. INP_Tor-2511)/ 
cover-image: img/bioinformatics_logo.png
description: |
  Workshop website for the Enter Year Here Enter Full Workshop Name Here (e.g. Introduction to Python) Canadian Bioinformatics Workshop
link-citations: yes
github-repo: bioinformaticsdotca/Workshop Code (e.g. INP_Tor-2511)
...
Welcome to the Enter Year Here Enter Full Workshop Name Here (e.g. Introduction to Python) Canadian Bioinformatics Workshop webpage!  
